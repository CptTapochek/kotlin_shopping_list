...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxRoomCompilerLibraryAccessors extends SubDependencyFactory {
        private final AndroidxRoomCompilerProcessingLibraryAccessors laccForAndroidxRoomCompilerProcessingLibraryAccessors = new AndroidxRoomCompilerProcessingLibraryAccessors(owner);

        public AndroidxRoomCompilerLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.room.compiler.processing</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxRoomCompilerProcessingLibraryAccessors getProcessing() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxRoomCompilerProcessingLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxRoomCompilerProcessingLibraryAccessors extends SubDependencyFactory {

        public AndroidxRoomCompilerProcessingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>testing</b> with <b>androidx.room:room-compiler-processing-testing</b> coordinates and
         * with version reference <b>roomCompilerProcessingTesting</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getTesting() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.room.compiler.processing.testing");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>roomCompilerProcessingTesting</b> with value <b>2.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRoomCompilerProcessingTesting() { return getVersion("roomCompilerProcessingTesting"); }
